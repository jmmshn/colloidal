                        ...
                        for(int jy = iy-1; jy<=iy+1; ++jy) {
                            ...
                            for(list<Particle*>::iterator j=Part_list[jx][jy].begin(); j != Part_list[jx][jy].end(); ++j) {
                                ...
                                if (p1!=p2) {
                                    ...
                                    double y1 =  p1->y;
                                    double y2 =  p2->y;
                                    double VCMx = (p1->vx + p2->vx)/2;
                                    double VCMy = (p1->vy + p2->vy)/2;
                                    double u1 =  p1->vx-VCMx;
                                    double v1 =  p1->vy-VCMy;
                                    double u2 =  p2->vx-VCMx;
                                    double v2 =  p2->vy-VCMy;
                                    ...
                                    p1->vx=(VN1_F*cos(theta))-(VT1*sin(theta))+VCMx;
                                    p1->vy=(VN1_F*sin(theta))+(VT1*cos(theta))+VCMy;
                                    p2->vx=(VN2_F*cos(theta))-(VT2*sin(theta))+VCMx;
                                    p2->vy=(VN2_F*sin(theta))+(VT2*cos(theta))+VCMy;
